...
<title>SQL Comparison operator - w3resource</title>
<meta name="Keywords" content="SQL Comparison operator, SQL Equal to ( = ) operator, SQL Greater than ( &gt; ) operator, SQL Less than ( &lt; ) operator, SQL Greater than or equal to ( &gt;= ) operator, SQL Less than or equal to ( <= ) operator, SQL Not equal to  operator, SQL tutorials, w3resource" />
<meta name="description" content="SQL Comparison operator: A comparison or relational operator is a mathematical symbol which is used to compare between two values.">
<meta property="og:title" content="SQL Comparison operator - w3resource" />
<meta property="og:description" content="SQL Comparison operator: A comparison or relational operator is a mathematical symbol which is used to compare between two values." />
<meta property="og:type" content="tutorial" />
<meta property="og:url" content="https://www.w3resource.com/sql/comparison-operators/sql-comparison-operators.php" />
...
<ul class='nav nav-list'><li><a href='/index.php' itemscope itemtype='http://schema.org/WebPageElement/SiteNavigationElement'>Home</a></li><li><a href='/sql/tutorials.php' itemscope itemtype='http://schema.org/WebPageElement/SiteNavigationElement'>SQL Home</a></li><li class='nav-header'>&#9660;Operators</li><li><a href='/sql/operators.php' itemscope itemtype='http://schema.org/WebPageElement/SiteNavigationElement'> SQL Operators</a></li><li><a href='/sql/arithmetic-operators/sql-arithmetic-operators.php' itemscope itemtype='http://schema.org/WebPageElement/SiteNavigationElement'> Arithmetic Operator</a></li><li class='active'><a href='/sql/comparison-operators/sql-comparison-operators.php' itemscope itemtype='http://schema.org/WebPageElement/SiteNavigationElement'>Comparison Operator</a></li><li class='nav-header'>&#9660;Logical Operators</li><li><a href='/sql/boolean-operator/sql-boolean-operators.php' itemscope itemtype='http://schema.org/WebPageElement/SiteNavigationElement'> Logical Operators</a></li><li><a href='/sql/in-operator/sql-in-operator.php' itemscope itemtype='http://schema.org/WebPageElement/SiteNavigationElement'> IN</a></li><li><a href='/sql/between-operator/sql-between-operator.php' itemscope itemtype='http://schema.org/WebPageElement/SiteNavigationElement'> BETWEEN</a></li><li><a href='/sql/special-operators/sql_any.php' itemscope itemtype='http://schema.org/WebPageElement/SiteNavigationElement'> ANY</a></li><li><a href='/sql/special-operators/sql_all.php' itemscope itemtype='http://schema.org/WebPageElement/SiteNavigationElement'> ALL</a></li><li><a href='/sql/special-operators/sql_some.php' itemscope itemtype='http://schema.org/WebPageElement/SiteNavigationElement'> SOME</a></li><li><a href='/sql/special-operators/sql_exists.php' itemscope itemtype='http://schema.org/WebPageElement/SiteNavigationElement'> EXISTS</a></li><li class='nav-header'>&#9660;SQL Wildcards &amp; LIKE Operators</li><li><a href='/sql/wildcards-like-operator/wildcards-like-operator.php' itemscope itemtype='http://schema.org/WebPageElement/SiteNavigationElement'> LIKE</a></li></ul> </div>
<div class="mdl-cell mdl-card mdl-shadow--2dp through mdl-shadow--6dp mdl-cell--7-col">
<article itemscope itemtype="https://schema.org/TechArticle">
<h1 class="heading" id="h_one">SQL Comparison operator</h1>
<time itemprop="dateModified" datetime="August 19 2022 21:51:36.">Last update on August 19 2022 21:51:36 (UTC/GMT +8 hours)</time>
<style type="text/css">
...
<p>A comparison (or relational) operator is a mathematical symbol which is used to compare two values.</p>
<p>Comparison operators are used in conditions that compares one expression with another. The result of a comparison can be TRUE, FALSE, or UNKNOWN (an operator that has one or two NULL expressions returns UNKNOWN).</p>
<p>The following table describes different types of comparison operators - </p>
...
<td>=</td>
<td>Equal to. </td>
<td>Any compatible data types</td>
</tr>
<tr>
<td>&gt;</td>
<td>Greater than. </td>
...
<pre class="well_syntax">SELECT[column_name| * |expression]&lt;comparison operator&gt;
...
<tr>
<td>column_name</td>
<td>Name of the column of a table.</td>
</tr>
<tr>
<td>*</td>
<td>Indicates all the columns of a table.</td>
</tr>
<tr>
<td>expression</td>
<td>Expression made up of a single constant, variable, scalar function, or column name and can also be the pieces of a SQL query that compare values against other values or perform arithmetic calculations.</td>
</tr>
<tr>
<td>table_name</td>
...
<td>Equal to (=), not equal to(&lt;&gt;), greater than(&gt;), less than(&lt;), greater than or equal to (&gt;=), less than or equal to (&lt;=).</td>
</tr>
</table>
</div>
...
<ul class="w3r_list">
<li><a href="#EQUAL">Equal to Operator</a></li>
<li><a href="#GREATER">Greater than Operator</a></li>
<li><a href="#LESS">Less than Operator</a></li>
<li><a href="#GE">Greater than or equal to Operator</a></li>
<li><a href="#LE">Less than or equal to Operator</a></li>
<li><a href="#NOTEQ">Not equal to Operator</a></li></ul></div>
</ul>
<p><strong>Example: SQL Comparison operator</strong></p>
<p>To get a comparison between two numbers
from the <a href="https://www.w3resource.com/sql/sql-dual-table.php">DUAL</a> table, the following SQL statement can be used :</p>
<pre class="line-numbers"><code class="language-sql">SELECT 15&gt;14 FROM dual;
</code></pre>
<h2 ID='EQUAL'>SQL Equal to ( = ) operator </h2>
<p>The equal to operator is used for equality test within two numbers or expressions.</p>
<p><strong>Example: </strong></p>
<p>Sample table: agents</p>
<div class="row-fluid">
<iframe src="/sql/agents.php" height="175" class="span12"></iframe>
</div><br>
<p>To get data of all columns from the 'agents' table with the following condition -</p>
<p>1. 'commission' is equal to .15,<br />
<br />
...
<p>Output:</p>
<pre class="output" style="overflow: scroll;">AGENT_ AGENT_NAME                     WORKING_AREA      COMMISSION PHONE_NO        COUNTRY
------ ------------------------------ ----------------- ---------- --------------- --------
...
<img src='https://www.w3resource.com/w3r_images/sql-comparison-equal-to-operator-exercise-relational-algebra.png' alt="Relational Algebra Expression: SQL Equal to ( = ) operator." style="max-width:100%;display:block;height:auto;border: 2px solid silver" /><br>
<p><strong>Relational Algebra Tree:</strong></p>
<img src='https://www.w3resource.com/w3r_images/sql-comparison-equal-to-operator-exercise-relational-algebra-tree-diagram.png' alt="Relational Algebra Tree: SQL Equal to ( = ) operator." style="max-width:100%;display:block;height:auto;border: 2px solid silver" /><br>
<h2 ID='GREATER'>SQL Greater than ( &gt; ) operator</h2>
<p>The greater than operator is used to test whether an expression (or number) is greater than another one.</p>
<p><strong>Example:</strong></p>
<p>To get data of all columns from the 'agents' table with the following condition -</p>
<p>1. 'commission' is greater than .14,<br />
<br />
the following SQL statement can be used :</p>
<p><strong>SQL Code:</strong></p>
<pre class="line-numbers"><code class="language-sql">SELECT&nbsp;*
...
<p>Output:</p>
<pre class="output">AGENT_ AGENT_NAME     WORKING_AREA                        COMMISSION PHONE_NO        COUNTRY
------ -------------- ----------------------------------- ---------- --------------- -------
A007   Ramasundar     Bangalore                                  .15 077-25814763
A011   Ravi Kumar     Bangalore                                  .15 077-45625874
A006   McDen          London                                     .15 078-22255588
...
<p><strong>Relational Algebra Expression:</strong></p>
<img src='https://www.w3resource.com/w3r_images/sql-comparison-greater-than-operator-exercise-relational-algebra.png' alt="Relational Algebra Expression: SQL Greater than ( &gt; ) operator." style="max-width:100%;display:block;height:auto;border: 2px solid silver" /><br>
<p><strong>Relational Algebra Tree:</strong></p>
<img src='https://www.w3resource.com/w3r_images/sql-comparison-greater-than-operator-exercise-relational-algebra-tree-diagram.png' alt="Relational Algebra Tree: SQL Greater than ( &gt; ) operator." style="max-width:100%;display:block;height:auto;border: 2px solid silver" /><br>
<h2 ID='LESS'>SQL Less than ( &lt; ) operator </h2>
<p>The less than operator is used to test whether an expression (or number) is less than another one. </p>
<strong>Example:</strong>
<p>To get data of all columns from the 'agents' table with the following condition -</p>
<p>1. 'commission' is less than .12,<br />
<br />
the following SQL statement can be used :</p>
<p><strong>SQL Code:</strong></p>
<pre class="line-numbers"><code class="language-sql">SELECT&nbsp;*
...
<p><strong>Relational Algebra Expression:</strong></p>
<img src='https://www.w3resource.com/w3r_images/sql-comparison-less-than-operator-exercise-relational-algebra.png' alt="Relational Algebra Expression: SQL Less than ( &lt; ) operator." style="max-width:100%;display:block;height:auto;border: 2px solid silver" /><br>
<p><strong>Relational Algebra Tree:</strong></p>
<img src='https://www.w3resource.com/w3r_images/sql-comparison-less-than-operator-exercise-relational-algebra-tree-diagram.png' alt="Relational Algebra Tree: SQL Less than ( &lt; ) operator." style="max-width:100%;display:block;height:auto;border: 2px solid silver" /><br>
<h2 ID='GE'>SQL Greater than or equal to ( &gt;= ) operator </h2>
<p>The greater than equal to operator is used to test whether an expression (or number) is either greater than or equal to another one. </p>
<p><strong>Example:</strong></p>
<p>To get data of all columns from the 'agents' table with the following condition -</p>
<p>1. 'commission' is greater than or equal to .14,<br />
<br />
the following SQL statement can be used :</p>
<p><strong>SQL Code:</strong></p>
<pre class="line-numbers"><code class="language-sql">SELECT&nbsp;*
...
<p><strong>Relational Algebra Expression:</strong></p>
<img src='https://www.w3resource.com/w3r_images/sql-comparison-greater-than-or-equal-to-operator-exercise-relational-algebra.png' alt="Relational Algebra Expression: SQL Greater than or equal to ( &gt;= ) operator." style="max-width:100%;display:block;height:auto;border: 2px solid silver" /><br>
<p><strong>Relational Algebra Tree:</strong></p>
<img src='https://www.w3resource.com/w3r_images/sql-comparison-greater-than-or-equal-to-operator-exercise-relational-algebra-tree-diagram.png' alt="Relational Algebra Tree: SQL Greater than or equal to ( &gt;= ) operator." style="max-width:100%;display:block;height:auto;border: 2px solid silver" /><br>
<h2 ID='LE'>SQL Less than or equal to ( &lt;= ) operator </h2>
<p>The less than equal to operator is used to test whether an expression (or number) is either less than or equal to another one. </p>
<p><strong>Example:</strong></p>
<p>To get data of all columns from the 'agents' table with the following condition -</p>
<p>1. commission is less than or equal to .12,<br />
<br />
the following SQL statement can be used :</p>
<p><strong>SQL Code:</strong></p>
<pre class="line-numbers"><code class="language-sql">SELECT&nbsp;*
...
<p><strong>Relational Algebra Expression:</strong></p>
<img src='https://www.w3resource.com/w3r_images/sql-comparison-less-than-or-equal-to-operator-exercise-relational-algebra.png' alt="Relational Algebra Expression: SQL Less  than or equal to ( &lt;= ) operator." style="max-width:100%;display:block;height:auto;border: 2px solid silver" /><br>
<p><strong>Relational Algebra Tree:</strong></p>
<img src='https://www.w3resource.com/w3r_images/sql-comparison-less-than-or-equal-to-operator-exercise-relational-algebra-tree-diagram.png' alt="Relational Algebra Tree: SQL Less  than or equal to ( &lt;= ) operator." style="max-width:100%;display:block;height:auto;border: 2px solid silver" /><br>
<h2 ID='NOTEQ'>SQL Not equal to ( &lt;&gt; ) operator </h2>
<p>The not equal to operator is used for inequality test between two numbers or expression.</p>
<strong>Example:</strong>
<p>To get data of all columns from the 'agents' table with the following condition -</p>
<p>1. commission is not equal to .15,</p>
...
<p><strong>Relational Algebra Expression:</strong></p>
<img src='https://www.w3resource.com/w3r_images/sql-comparison-not-equal-to-operator-exercise-relational-algebra.png' alt="Relational Algebra Expression: SQL Not equal to ( &lt;&gt; ) operator." style="max-width:100%;display:block;height:auto;border: 2px solid silver" /><br>
<p><strong>Relational Algebra Tree:</strong></p>
<img src='https://www.w3resource.com/w3r_images/sql-comparison-not-equal-to-operator-exercise-relational-algebra-tree-diagram.png' alt="Relational Algebra Tree: SQL Not equal to ( &lt;&gt; ) operator." style="max-width:100%;display:block;height:auto;border: 2px solid silver" /><br>
<p><a href="/sql/sql-table.php">See our Model Database</a></p>
<h2></h2>
...
<h2></h2>
<p><strong>Want to improve the above article? Contribute your Notes/Comments/Examples through Disqus.</strong></p></article>
﻿<style type="text/css">
...
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/v2b4487d741ca48dcbadcaf954e159fc61680799950996" integrity="sha512-D/jdE0CypeVxFadTejKGTzmwyV10c1pxZk/AqjJuZbaJwGMyNHY3q/mTPWqMUnFACfCTunhZUVcd4cV78dK1pQ==" data-cf-beacon='{"rayId":"7b68aeb96eb69fbf","version":"2023.3.0","b":1,"token":"5dac2d8f3d14427aab9e85de0419fad9","si":100}' crossorigin="anonymous"></script>
</body>
</html>
